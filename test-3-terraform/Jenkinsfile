                ...
                script {
                    ...
                    sh """
                        terraform init \
                            ...
                            -backend-config="key=test-3/terraform.tfstate" \
        ...
        success {
            script {
                ...
                *Duration:* ${currentBuild.durationString}
                ...
                emailext(
                    subject: "✅ Terraform ${params.ACTION} Successful - test-3",
                    body: """
                        <h2>Terraform Deployment Successful</h2>
                        <p><strong>Project:</strong> test-3</p>
        ...
        failure {
            script {
                ...
                *Build:* #${env.BUILD_NUMBER}
                ...
                emailext(
                    subject: "❌ Terraform ${params.ACTION} Failed - test-3",
                    body: """
