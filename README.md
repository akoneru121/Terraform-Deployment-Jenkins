# test-3 - EKS Terraform Configuration
...
- **Node Group**: 2-6 nodes (desired: 3)
...
- **Worker Nodes** (3 x t2.micro): Varies by instance type
...
✅ Use SPOT instances instead of ON_DEMAND (up to 70% savings)
✅ Scale down during off-hours
✅ Enable Cluster Autoscaler to right-size nodes
✅ Use Fargate for bursty workloads

✅ Consider Single NAT for non-production environments
...
4. **Configure kubectl**
   ```bash
   aws eks update-kubeconfig --region us-east-1 --name test-3-eks
   ```
